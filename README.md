...
2. Claims are first-class, typed, machine-readable objects  
3. Evidence Provenance Graph (independent convergence ≠ derivative echo)  
4. Fundamental Knowledge Gate (Unknown / Tension / Strong Conflict / Potential Anomaly)  
5. Bounded Ethical Audit (cannot inflate factual weight)  
6. Transparent ASC (Argument Strength Coefficient) with full component breakdown
